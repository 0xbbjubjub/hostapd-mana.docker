        ...
        in {
          ...
          in
            hci-effects.mkEffect {
              ...
              effectScript = ''
                ...
                skopeo --insecure-policy copy nix:${image} docker://ghcr.io/bbjubjub2494/hostapd-mana.docker:latest-${system}
              '';
            };
          ...
          in
            hci-effects.mkEffect {
              ...
              effectScript = ''
                readSecretString password .token | skopeo login ghcr.io -u bbjubjub2494 --password-stdin
                skopeo --insecure-policy copy nix:${image} docker://ghcr.io/bbjubjub2494/hostapd-mana.docker:latest-aarch64-linux
              '';
            };
        }
      );
